#' @title Scatter plot matrices with Histograms and
...
# rcolor <- function(n = 5)
# {
#     .col <- c("white", "aliceblue", "antiquewhite",
...
#               "beige", "bisque", "bisque1", "bisque2", "bisque3",
#               "bisque4", "black", "blanchedalmond", "blue",
...
#               "forestgreen", "gainsboro", "ghostwhite", "gold", "gold1",
...
#               "gray37", "gray38", "gray39", "gray40", "gray41", "gray42",
...
#               "gray97", "gray98", "gray99", "gray100", "green", "green1",
#               "green2", "green3", "green4", "greenyellow", "honeydew",
...
#               "indianred4", "ivory", "ivory1", "ivory2", "ivory3",
...
#               "peachpuff3", "peachpuff4", "peru", "pink", "pink1",
#               "pink2", "pink3", "pink4", "plum", "plum1", "plum2",
#               "plum3", "plum4", "powderblue", "purple", "purple1",
#               "purple2", "purple3", "purple4", "red", "red1", "red2",
...
#               "violetred2", "violetred3", "violetred4", "wheat",
#               "wheat1", "wheat2", "wheat3", "wheat4", "whitesmoke",
#               "yellow", "yellow1", "yellow2", "yellow3", "yellow4",
#               "yellowgree")
#
#     .index <- round(runif(n, min = 1, max = length(.col)), 0)
#     .col[.index]
# }
#
#
