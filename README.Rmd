...
In a nutshell, mStats is designed to make data analysis quick and easy to create the final report for health research project. You can see it in action to [Get Started](./docs/articles/mStats.html).
...
The easiest way to get started with mStats is to follow the guide [here](./docs/articles/mStats.html). Below is a quick demonstration of what mStats can do. 
